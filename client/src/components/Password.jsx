    ...
    <div className="canvas">
        <div className='container'>
            ...
            <div className='header'>
             ...
             <div>
             <button style={{borderTop:'solid black 8px',borderRadius:'30% 30% 45% 45%',margin:'-10px'}} onClick={()=>{var x = document.getElementById("inputpassword");x.type='text';setTimeout(()=>{x.type='password'},2000)}}><lord-icon src="https://cdn.lordicon.com/mgszhlom.json"trigger="click" style={{width:'50px',height:'50px',margin:'-10px'}}></lord-icon></button>
